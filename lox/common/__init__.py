...
from lox.common.aliases import AliasedCommands
from lox.common.constants import RE_FEAT
from lox.common.files import (
    compress,
    create_relative_path,
    get_audio_files,
)
from lox.common.regexes import (
    parse_copyright,
    re_split,
    re_strip,
)
from lox.common.strings import (
    fetch_genre,
    less_uppers,
    make_searchstrs,
    normalize_accents,
...
async def commandgroup() -> None:
    """Main command group for lox CLI."""
    pass
